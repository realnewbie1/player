...
function init() {
  ...
  var html = `
   <center> <h1><font face="georgia">Movies Theater</font></h1>
...
function nav(path) {
  ...
  html += `<select class="mdui-select" onchange="window.location.href=this.value" style="overflow:visible;width: 100%">`;
  names.forEach((name, idx) => {
    html += `<option value="/${idx}:/"  ${
      idx === cur ? 'selected="selected"' : ""
    } >${name}</option>`;
  });
  html += `</select><div class="mdui-toolbar nav-style dummyclass3" style="margin-top:0px!important;display:none">`;
  ...
  var search_bar = `<div class="mdui-toolbar-spacer"></div>
        ...
        }" style="max-width:${isMobile ? 300 : 400}px;display: none">
...
function list(path) {
  ...
  <button onclick="history.back()" style="width: 100%; background-color: green; padding: 0; height: 50px; border: none;">
    &lt;&lt; Previous Page
  </button>
  <br/><br/>
	 <div class="mdui-row"> 
